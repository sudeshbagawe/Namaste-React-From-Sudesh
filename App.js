...
const  resobj=  [
  ...
  },
  {
    "info": {
      "id": "9052",
      "name": "Subway",
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/8/13/f1042a40-6c67-4a11-b2cc-11f2337150be_9052.jpg",
      "locality": "Central Plaza, Kalina",
      "areaName": "Santacruz East",
      "costForTwo": "₹350 for two",
      "cuisines": [
  ...
  },
  {
    ...
    "analytics": {},
    "cta": {
      "link": "https://www.swiggy.com/city/mumbai/ubq-by-barbeque-nation-kalina-bandra-east-rest448491",
      "type": "WEBLINK"
    }
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-09-30 02:45:00",
        "opened": true
      },
      "badges": {
        "imageBadges": [
  ...
  },
  {
    "info": {
      "id": "24463",
      "name": "Domino's Pizza",
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/9/17/5adcdff2-8cfa-4052-af00-ce9d2ab8d9ca_24463.jpg",
      "locality": "Kurla East",
      "areaName": "Kurla West",
      "costForTwo": "₹400 for two",
      "cuisines": [
  ...
  },
  {
    ...
    "analytics": {},
    "cta": {
      "link": "https://www.swiggy.com/city/mumbai/salad-days-vip-road-powai-rest815275",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    "info": {
      ...
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/24/bbb653ed-0854-48d8-a2fc-324e0ebc4d7b_678581.JPG",
      "locality": "Gaurav Industrial Estate",
      "areaName": "Kurla West",
      "costForTwo": "₹250 for two",
      "cuisines": [
  ...
  },
  {
    "info": {
      ...
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/9/17/cbab4032-e112-4187-b83d-657abdd2dcc7_62894.jpg",
      "locality": "Kalina",
      "areaName": "Santacruz East",
      "costForTwo": "₹200 for two",
      "cuisines": [
  ...
  },
  {
    "info": {
      "id": "558805",
      "name": "HRX by EatFit",
      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/8/1/b43f2561-7bab-4119-9087-abcd101787ef_558805.jpg",
      "locality": "CST Road",
      "areaName": "Santacruz East",
...
const RestroCard = (props) => {
  ...
  const {name,cloudinaryImageId,cuisines,costForTwo,areaName,availability,id}= resData.info;
 console.log(resData)
  return (
...
const Body = () => {
  ...
  return (
    <div className="body">
      ...
      {
  resobj.map(restaurant=><RestroCard resData={restaurant } key= {restaurant.info.id} />)
}
      </div>
    </div>
  );
